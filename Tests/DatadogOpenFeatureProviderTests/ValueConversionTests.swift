...
@Suite("Value to Swift Any Conversion")
struct ValueToAnyTests {
    
    @Test("All types to Any conversion")
    func allTypesToAnyConversion() async throws {
...
@Suite("Value to String Conversion")
struct ValueToStringTests {
    
    @Test("All types to string conversion")
    func allTypesToStringConversion() async throws {
