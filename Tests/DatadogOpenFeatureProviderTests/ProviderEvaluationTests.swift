...
@Test func testBooleanProviderEvaluationCreation() async throws {
    // Given
...
@Test func testStringProviderEvaluationCreation() async throws {
...
@Test func testDoubleProviderEvaluationCreation() async throws {
...
@Test func testInt64ProviderEvaluationCreation() async throws {
...
@Test func testValueProviderEvaluationCreation() async throws {
...
@Test func testProviderEvaluationWithNilVariantAndReason() async throws {
    let flagDetails = FlagDetails<Bool>(
        key: "simple-flag",
        value: false,
        variant: nil,
...
@Test func testProviderEvaluationWithContext() async throws {
...
@Test func testProviderEvaluationWithComplexAnyValue() async throws {
...
@Test func testProviderEvaluationLargeIntConversion() async throws {
    let flagDetails = FlagDetails<Int>(
        key: "large-number",
        value: Int.max,
        variant: "maximum",
