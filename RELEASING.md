...
The provider version is independent from its OpenFeature dependency version. For example, updating the dependency to OpenFeature 0.3.1 does not require publishing provider 0.3.1.
